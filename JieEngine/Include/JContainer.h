...
/*
    ...
    方法名:              用法:
    JContainer          默认无参构造函数调用后 使用前必须调用SetNull 设置Null值否则程序会崩溃
    JContainer          构造函数需要设置Null值
    JContainer          拷贝构造函数
    At                  获取索引值
    Size                获取容器数据数量
    Capacity            获取容器容量
