...
class Still : public Component{
    public:
        ...
        */
        virtual void SetData(char * FileUrl,short ImageInciseNumber,short PlaySpeed,SDL_Point Position,SDL_Surface * WindowSurface){
        ...
        */
        virtual void SetData(char * FileUrl,SDL_Point Position,SDL_Surface * WindowSurface){
